...
export const subscriptionPlans: RecurringPlan[] = [
  {
    ...
    name: "Starter",
    description: "Perfect for trying things out.",
    monthlyPriceId: "price_REPLACE_WITH_STARTER_MONTHLY_ID",
    yearlyPriceId: "price_REPLACE_WITH_STARTER_YEARLY_ID",
    monthlyPrice: 9,
    yearlyPrice: 90,
    currency: "usd",
    features: [
  ...
  },
  {
    ...
    name: "Pro",
    description: "Best for professionals and small teams.",
    monthlyPriceId: "price_REPLACE_WITH_PRO_MONTHLY_ID",
    yearlyPriceId: "price_REPLACE_WITH_PRO_YEARLY_ID",
    monthlyPrice: 29,
    yearlyPrice: 290,
    currency: "usd",
    highlighted: true,
  ...
  },
  {
    ...
    name: "Enterprise",
    description: "For large teams with custom needs.",
    monthlyPriceId: "price_REPLACE_WITH_ENTERPRISE_MONTHLY_ID",
    yearlyPriceId: "price_REPLACE_WITH_ENTERPRISE_YEARLY_ID",
    monthlyPrice: 79,
    yearlyPrice: 790,
    currency: "usd",
    features: [
